  ...
  static technicalSkills: object = () => ({
    ...
    others: {
      ...
      data: [
        ...
        { name: 'EC2', proficiency: proficiency.proficient },
        { name: 'S3', proficiency: proficiency.proficient },
        { name: 'RDS', proficiency: proficiency.proficient },
        { name: 'Amazon CloudWatch', proficiency: proficiency.high },
        { name: 'Amazon Cognito', proficiency: proficiency.high },
